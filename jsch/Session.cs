...
namespace Tamir.SharpSsh.jsch
{
    public class Session : Runnable
    {
        ...
        private static readonly String version = "SharpSSH-" + SshBase.Version + "-JSCH-0.1.28";
        internal static Random random;
        internal static object randomLock = new object();
        private readonly GlobalRequestReply grr = new GlobalRequestReply();
        private readonly int[] uncompress_len = new int[1];
        ...
        internal SocketFactory socket_factory;
                       ...
                       thread != null)
                {
                    ...
                    switch (msgType)
                    {
                        ...
                        case SSH_MSG_GLOBAL_REQUEST:
                            ...
                            {
                                packet.reset();
                                buf.putByte(SSH_MSG_REQUEST_FAILURE);
                                write(packet);
                            }
                            break;
        ...
        public void connect(int connectTimeout)
        {
            ...
            try
            {
                ...
                var usn = new UserAuthNone(userinfo);
                auth = usn.start(this);
...
//					((buf.buffer[3]    )&0x000000ff);
		...
		*/
        ...
        {
            setPortForwardingR(rport, host, lport, null);
        }
        ...
        private void setPortForwarding(int rport)
        {
            lock (grr)
            {
                ...
                try
                {
                    ...
                    packet.reset();
                    buf.putByte(SSH_MSG_GLOBAL_REQUEST);
        ...
        #region Nested type: GlobalRequestReply
